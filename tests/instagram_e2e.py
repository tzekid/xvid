...
class Handler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        assert json.loads(values['variables'][0])['shortcode'] == 'GraphQL'
        return self.reply(200, json.dumps({'data': {'xdt_api__v1__media__shortcode__web_info': {'items': [post('GraphQL')]}}}).encode())
